...
export default function Hero({ cvLoading, generateCV, darkMode }) {
  ...
  const roles = useMemo(() => ['QA Tester', 'Frontend Developer', 'Web Designer', 'Problem Solver'], []);
  ...
  const socialIcons = [
    ...
    { icon: 'facebook-f', url: socialLinks.facebook },
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <div className="text-slate-600 dark:text-slate-300 text-lg my-4 h-8">
            ...
            <div className="flex gap-4 my-4">
              <MagneticButton>
                <a
                  href="#contact"
                  className="inline-block bg-blue-600 text-white px-6 py-2 rounded-full font-semibold shadow-md transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/30"
                >
                  Hire Me
                </a>
              </MagneticButton>
